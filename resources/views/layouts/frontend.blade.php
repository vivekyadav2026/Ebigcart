...
<head>
    ...
    <link rel="icon" href="https://www.mahadev_tractor_modification_.com/wp-content/themes/mahadev_tractor_modification_/assets/images/favicon.png" sizes="72x72">
    >
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/1cc-product-checkout.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/animate.min.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/app.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/blocks.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/custom.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/dashicons.min.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/default-skin.min.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/frontend.min.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/joinchat.min.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/owl.carousel.min.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/photoswipe.min.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/print.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/responsive-new.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/style(1).css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/style.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/styles.css">
    <link rel="stylesheet" href="/mahadev_tractor_modification__assets/v2.6fff8c3f.33524.css">

    <script src="/mahadev_tractor_modification__assets/jquery.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/jquery-migrate.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/add-to-cart.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/ajax-geolocation.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/bootstrap.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/bundle.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/facebook_signal.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/fbevents.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/forms.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/hooks.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/hoverIntent.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/i18n.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/index(1).js.download"></script>
    <script src="/mahadev_tractor_modification__assets/index.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/init.9207427f95fa799d6604.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/init.d14c94a333a298606fff.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/joinchat.min.js.download"></script>
    
    <script src="/mahadev_tractor_modification__assets/jquery.blockUI.min.js.download"></script>
    
    <script src="/mahadev_tractor_modification__assets/js.cookie.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/magic-checkout.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/magic-rzp.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/maxmegamenu.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/order-attribution.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/owl.carousel.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/photoswipe-ui-default.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/photoswipe.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/primary-navigation.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/recorder.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/responsive-embeds.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/slick.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/sourcebuster.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/v2-entry.modern.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/woocommerce.min.js.download"></script>
    <script src="/mahadev_tractor_modification__assets/wp-emoji-release.min.js.download"></script>
...
<body class="font-sans antialiased text-black bg-white" x-data="{ mobileMenuOpen: false }">
    ...
    <!-- Main Content -->
    <main class="@yield('main_class', 'container my-4 min-vh-100 pb-5')">
