...
<title>Download Ebigcart App</title>
<meta name="description" content="Download the Ebigcart Web App for the best shopping experience on your phone.">
...
<main class="container py-5 mt-4 mb-5">
    <div class="app-card">
        <img src="{{ asset('images/icons/icon-512x512.png') }}" alt="Ebigcart App" class="app-icon-large">
        <h1 class="fw-bold" style="font-family: 'Outfit', sans-serif; color: var(--pl-primary-dark); font-size: 2rem;">Ebigcart App</h1>
