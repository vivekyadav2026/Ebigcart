...
@section('content')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div class="prose max-w-none text-gray-600 leading-relaxed font-sans text-sm sm:text-base space-y-6">
            ...
            <p>
                Welcome to <strong>Mahadev Tractor</strong>. We are committed to delivering our fresh, high-quality groceries, beverages, and daily essentials safely and efficiently right to your doorstep.
            </p>
