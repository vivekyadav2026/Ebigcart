...
@section('content')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div class="prose max-w-none text-gray-600 leading-relaxed font-sans text-sm sm:text-base space-y-6">
            ...
            <p>
                At <strong>Ebigcart</strong>, customer satisfaction is our top priority. Since our products are fresh groceries, beverages, and organic daily essentials, we take great care in ensuring the highest quality. Please read our policy on returns and refunds below.
            </p>
