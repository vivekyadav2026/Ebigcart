...
@section('content')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div class="prose max-w-none text-gray-600 leading-relaxed font-sans text-sm sm:text-base space-y-6">
            ...
            <p>
                Welcome to <strong>Mahadev Tractor</strong>. By accessing or using our website, ordering our products, or utilizing any of our services, you agree to comply with and be bound by the following terms and conditions. Please read them carefully.
            </p>
            ...
            <p>
                All content included on this site, such as text, graphics, logos, button icons, images, audio clips, digital downloads, and data compilations, is the property of <strong>Mahadev Tractor</strong> or its content suppliers and is protected by international copyright laws.
            </p>
